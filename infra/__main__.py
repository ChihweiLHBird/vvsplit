"""bunnysplit — Cloudflare Worker (static assets), Pulumi + Python.
...
# Optional custom domain (e.g. bunnysplit.zliang.me). Cloudflare auto-creates the
